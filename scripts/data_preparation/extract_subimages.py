...
def main():
    ...
    # opt['save_folder'] = 'F:/Datasets/SuperResolution/DeepSR_real/DF2K_train_LR_real/X2_sub'
    # opt['crop_size'] = 240
    # opt['step'] = 120
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
    ...
    # # LRx3 images
    # opt['input_folder'] = 'F:/Datasets/SuperResolution/DeepSR_real/DF2K_train_LR_real/X3'
    # opt['save_folder'] = 'F:/Datasets/SuperResolution/DeepSR_real/DF2K_train_LR_real/X3_sub'
    # opt['crop_size'] = 160
    # opt['step'] = 80
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
    ...
    # # LRx4 images
    # opt['input_folder'] = 'F:/Datasets/SuperResolution/DeepSR_real/DF2K_train_LR_real/X4'
    # opt['save_folder'] = 'F:/Datasets/SuperResolution/DeepSR_real/DF2K_train_LR_real/X4_sub'
    # opt['crop_size'] = 120
    # opt['step'] = 60
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
